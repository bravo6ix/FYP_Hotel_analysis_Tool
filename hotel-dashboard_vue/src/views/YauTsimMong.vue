<template>
    <div>
      ...
      <b-container fluid class="mt--7">
        ...
        <b-row class="mt-5">
          <b-col xl="8" class="mb-5 mb-xl-0">
            <yau-tsim-mong-table></yau-tsim-mong-table>
          </b-col>
        </b-row>
        <!--End tables-->
      </b-container>
  ...
  import YauTsimMongTable from './Dashboard/YauTsimMongTable';
  ...
  export default {
    ...
    async created() {
      try {
        const response = await axios.get('http://localhost:3001/api/services/hotels/yautsimmong/total-price-per-month');
        const response2 = await axios.get('http://localhost:3001/api/services/hotels/yautsimmong');
